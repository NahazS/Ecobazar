...
function addwishlist(product) {
    ...
    add_row.innerHTML = `
        <td class="flex items-center">
            <img class="w-[100px]" src="${product.image}" class="product-image">
            <p>${product.name}</p>
        </td>
        <td>
        ...
        <td>
            <button class="flex items-center justify-center bg-[#00B207] text-white py-4 px-3 sm:px-10 rounded-[43px]">Add to Cart 
                <span class="ml-4">
